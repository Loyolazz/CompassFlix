...
export default function HeaderProfile({  nameUser, numberEvaluation, textEvaluation, photoUser }) {
    ...
    return (
        <View style={styles.containerProfile}>
                    ...
                    >
                        <View style={{ backgroundColor: '#fff', height: 150, borderRadius: 25, justifyContent: 'center', flex: 1, marginHorizontal: 40, marginVertical: 360, alignItems: 'center', paddingHorizontal: 15 }}>
                            ...
                            <View style={{ flexDirection: 'row', width: '60%', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <TouchableOpacity onPress={() => setVisibleModal(false)} style={{ width: 90, height: 30, backgroundColor: '#fff', borderRadius: 5, justifyContent: 'center', alignItems: 'center', borderWidth: 1 }}>
            ...
            <View style={styles.viewProfileInfo}>
                <Image source={photoUser} style={{ borderRadius: 40 }} />
